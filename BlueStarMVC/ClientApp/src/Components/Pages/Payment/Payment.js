...
export default function Payment() {
    ...
    useEffect(() => {
        axios.get(
            `https://f62f-27-74-247-133.ngrok-free.app/api/discount/GetDiscountById?discountID=${passengerInfo.Discount}`
        )
            .then(res => {
            ...
            <div className="payment-body">
                ...
                <div>
                    <button className="payment-zalopay"
                            onClick={() => {
                                  axios.post("https://f62f-27-74-247-133.ngrok-free.app/api/zalo", jsonData)
                                       .then(response => {
