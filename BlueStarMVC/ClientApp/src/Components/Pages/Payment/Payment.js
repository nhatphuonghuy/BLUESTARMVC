...
export default function Payment() {
    ...
    useEffect(() => {
        axios.get(
            `https://b94f-171-224-240-4.ngrok-free.app/api/discount/GetDiscountById?discountID=${passengerInfo.Discount}`
        )
            .then(res => {
            ...
            <div className="payment-body">
                ...
                <div>
                    <button className="payment-zalopay"
                        onClick={() => {
                            axios.post("https://b94f-171-224-240-4.ngrok-free.app/api/zalo", jsonData)
                                .then(response => {
